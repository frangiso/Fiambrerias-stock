...
export default function Login() {
  ...
  function cambiarModo(m) {
    setModo(m); setError(''); setPassword(''); setPassword2('')
  }
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      setError(ERRORES_FIREBASE[err.code] || (modo === 'registro' ? 'No se pudo crear la cuenta' : 'Email o contraseña incorrectos'))
    }
    setLoading(false)
  }
      ...
      <div style={{ background:'white', borderRadius:20, padding:40, width:'100%', maxWidth:380, boxShadow:'0 8px 32px rgba(0,0,0,0.1)', border:'1px solid #E2D9C8' }}>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" disabled={loading}
            ...
            {loading ? (modo==='registro' ? 'Creando cuenta...' : 'Ingresando...') : (modo==='registro' ? 'Crear cuenta' : 'Ingresar')}
          </button>
        </form>
